...
while read lineA
    do 
        ...
        filename="${filename/trim_results_all94/mapping_virulence}"
        ...
        bwa index ../snippy/ref/RefSeq_virulence.fasta
        bwa mem ../snippy/ref/RefSeq_virulence.fasta -t 3 -R "@RG\tID:$id\tSM:$id" $lineA $lineB > ${filename}.aln-pe.sam
